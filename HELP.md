...
* [Configure the Spring AOT Plugin](https://docs.spring.io/spring-native/docs/0.10.6/reference/htmlsingle/#spring-aot-maven)
...
see [the Getting Started section of the reference guide](https://docs.spring.io/spring-native/docs/0.10.6/reference/htmlsingle/#getting-started-buildpacks)
.
...
```
$ docker run --rm -p 8080:8080 spring-helloworld:0.0.1-SNAPSHOT
```
...
see [the Getting Started section of the reference guide](https://docs.spring.io/spring-native/docs/0.10.6/reference/htmlsingle/#getting-started-native-build-tools)
.
